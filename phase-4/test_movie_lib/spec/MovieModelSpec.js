describe('Movie Model',function(){
    ...
    it('Movies names',function(){
        ...
        expect(movie1.names()).toEqual('monalisa')
        expect(movie2.names()).toEqual('maina');
        expect(movie3.names()).toEqual('guru shishya');
        expect(movie4.names()).toEqual('kanasugar');
    ...
    it('checking the movies rating',function(){
        ...
        expect(movie1.rating()).toEqual('5.0')
        expect(movie2.rating()).toEqual('4.6')
        expect(movie3.rating()).toEqual('4.3')
        expect(movie4.rating()).toEqual('5.0')
